                  ...
                  attributes: {
                    include: [
                      [
                        ...
                        Sequelize.literal(`(${rssArticles}."point" - (CASE WHEN extract(epoch from NOW() - ${rssArticles}."pubDate") <= 24 * 60 * 2 * 60 THEN pow(1.00529236, extract(epoch from NOW() - ${rssArticles}."pubDate") / 60) ELSE 2100000000 END))`),
                        'calculatedPoint'
                      ],
                      [
                        Sequelize.literal(`(
